module.exports = [
"[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/connection.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var _os = _interopRequireDefault(__turbopack_context__.r("[externals]/os [external] (os, cjs)"));
var tls = _interopRequireWildcard(__turbopack_context__.r("[externals]/tls [external] (tls, cjs)"));
var net = _interopRequireWildcard(__turbopack_context__.r("[externals]/net [external] (net, cjs)"));
var _dns = _interopRequireDefault(__turbopack_context__.r("[externals]/dns [external] (dns, cjs)"));
var _constants = _interopRequireDefault(__turbopack_context__.r("[externals]/constants [external] (constants, cjs)"));
var _stream = __turbopack_context__.r("[externals]/stream [external] (stream, cjs)");
var _identity = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/@azure+identity@4.13.0/node_modules/@azure/identity/dist/commonjs/index.js [app-route] (ecmascript)");
var _coreAuth = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/@azure+core-auth@1.10.1/node_modules/@azure/core-auth/dist/commonjs/index.js [app-route] (ecmascript)");
...
var _debug = _interopRequireDefault(__turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/debug.js [app-route] (ecmascript)"));
var _events = __turbopack_context__.r("[externals]/events [external] (events, cjs)");
var _instanceLookup = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/instance-lookup.js [app-route] (ecmascript)");
var _transientErrorLookup = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/transient-error-lookup.js [app-route] (ecmascript)");
...
var _preloginPayload = _interopRequireDefault(__turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/prelogin-payload.js [app-route] (ecmascript)"));
var _login7Payload = _interopRequireDefault(__turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/login7-payload.js [app-route] (ecmascript)"));
var _ntlmPayload = _interopRequireDefault(__turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/ntlm-payload.js [app-route] (ecmascript)"));
...
var _rpcrequestPayload = _interopRequireDefault(__turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/rpcrequest-payload.js [app-route] (ecmascript)"));
var _sqlbatchPayload = _interopRequireDefault(__turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/sqlbatch-payload.js [app-route] (ecmascript)"));
var _messageIo = _interopRequireDefault(__turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/message-io.js [app-route] (ecmascript)"));
var _tokenStreamParser = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/token/token-stream-parser.js [app-route] (ecmascript)");
...
var _connector = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/connector.js [app-route] (ecmascript)");
...
var _ntlm = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/ntlm.js [app-route] (ecmascript)");
...
var _bulkLoadPayload = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/bulk-load-payload.js [app-route] (ecmascript)");
var _specialStoredProcedure = _interopRequireDefault(__turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/special-stored-procedure.js [app-route] (ecmascript)"));
var _package = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/package.json (json)");
var _url = __turbopack_context__.r("[externals]/url [external] (url, cjs)");
var _handler = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/tedious@19.2.0/node_modules/tedious/lib/token/handler.js [app-route] (ecmascript)");
   ...
   */ async performSentLogin7WithNTLMLogin(signal) {
        ...
        try {
            while(true){
                ...
                const tokenStreamParser = this.createTokenStreamParser(message, handler);
                await Promise.race([
                    (0, _events.once)(tokenStreamParser, 'end'),
                    signalAborted
                ]);
                if (handler.loginAckReceived) {
                    return handler.routingData;
   ...
   */ async performSentLogin7WithFedAuth(signal) {
        ...
        try {
            ...
            if (fedAuthInfoToken && fedAuthInfoToken.stsurl && fedAuthInfoToken.spn) {
                /** Federated authentication configation. */ const authentication = this.config.authentication;
                /** Permission scope to pass to Entra ID when requesting an authentication token. */ const tokenScope = new _url.URL('/.default', fedAuthInfoToken.spn).toString();
                /** Instance of the token credential to use to authenticate to the resource. */ let credentials;
                switch(authentication.type){
                    case 'token-credential':
                    ...
                    case 'azure-active-directory-msi-vm':
                    case 'azure-active-directory-msi-app-service':
                        const msiArgs = authentication.options.clientId ? [
                ...
                /** Access token retrieved from Entra ID for the configured permission scope(s). */ let tokenResponse;
                try {
                    ...
                    throw new AggregateError([
                        new _errors.ConnectionError('Security token could not be authenticated or authorized.', 'EFEDAUTH'),
                        err
                    ]);
                }
...
//# sourceMappingURL=9c4f3_tedious_lib_connection_438e92d5.js.map