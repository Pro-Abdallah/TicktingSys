module.exports = [
"[project]/Downloads/ITTickting Sys/node_modules/.pnpm/@azure+msal-node@3.8.6/node_modules/@azure/msal-node/lib/msal-node.cjs [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*! @azure/msal-node v3.8.6 2026-01-17 */ var http = __turbopack_context__.r("[externals]/http [external] (http, cjs)");
var https = __turbopack_context__.r("[externals]/https [external] (https, cjs)");
var uuid = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/uuid@8.3.2/node_modules/uuid/dist/esm-node/index.js [app-route] (ecmascript)");
var crypto = __turbopack_context__.r("[externals]/crypto [external] (crypto, cjs)");
var msalCommon = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/@azure+msal-common@15.14.1/node_modules/@azure/msal-common/lib/index.cjs [app-route] (ecmascript)");
var jwt = __turbopack_context__.r("[project]/Downloads/ITTickting Sys/node_modules/.pnpm/jsonwebtoken@9.0.3/node_modules/jsonwebtoken/index.js [app-route] (ecmascript)");
...
/*! @azure/msal-common v15.14.1 2026-01-17 */ /* eslint-disable header/header */ const name$1 = "@azure/msal-common";
 ...
 */ class ScopeSet {
    constructor(inputScopes){
        ...
        const scopeArr = inputScopes ? StringUtils.trimArrayEntries([
            ...inputScopes
        ]) : [];
 ...
 */ class ResponseHandler {
     ...
     */ static async generateAuthenticationResult(cryptoObj, authority, cacheRecord, fromTokenCache, request, idTokenClaims, requestState, serverTokenResponse, requestId) {
        ...
        const accountInfo = cacheRecord.account ? updateAccountTenantProfileData(AccountEntity.getAccountInfo(cacheRecord.account), undefined, idTokenClaims, cacheRecord.idToken?.secret) : null;
        return {
 ...
 * Copyright (c) Microsoft Corporation. All rights reserved.
 * Licensed under the MIT License.
 */ /** @internal */ class SilentFlowClient extends BaseClient {
    constructor(configuration, performanceClient){
        super(configuration, performanceClient);
    }
    /**
 ...
 */ class ClientAssertion {
     ...
     */ createJwt(cryptoProvider, issuer, jwtAudience) {
        ...
        this.jwt = jwt.sign(payload, this.privateKey, {
            header
        });
        return this.jwt;
    }
 ...
 */ class ClientApplication {
    ...
    async acquireCachedTokenSilent(validRequest, silentFlowClient, clientConfiguration) {
        const [authResponse, cacheOutcome] = await silentFlowClient.acquireCachedToken({
            ...validRequest,
            scopes: validRequest.scopes?.length ? validRequest.scopes : [
                ...OIDC_DEFAULT_SCOPES
            ]
        });
 ...
 */ class DeviceCodeClient extends BaseClient {
     ...
     */ async acquireTokenWithDeviceCode(request, deviceCodeResponse) {
        ...
        const headers = this.createTokenRequestHeaders();
        const userSpecifiedTimeout = request.timeout ? nowSeconds() + request.timeout : undefined;
 ...
 */ class MachineLearning extends BaseManagedIdentitySource {
     ...
     */ createRequest(resource, managedIdentityId) {
        ...
        request.queryParameters[ManagedIdentityQueryParameters.RESOURCE] = resource;
        if (managedIdentityId.idType === ManagedIdentityIdType.SYSTEM_ASSIGNED) {
            request.queryParameters[ManagedIdentityUserAssignedIdQueryParameterNames.MANAGED_IDENTITY_CLIENT_ID_2017] = process.env[ManagedIdentityEnvironmentVariableNames.DEFAULT_IDENTITY_CLIENT_ID]; // this environment variable is always set in an Azure Machine Learning source
        } else if (managedIdentityId.idType === ManagedIdentityIdType.USER_ASSIGNED_CLIENT_ID) {
            request.queryParameters[this.getManagedIdentityUserAssignedIdQueryParameterKey(managedIdentityId.idType, false, true // uses2017API
            )] = managedIdentityId.id;
        } else {
 ...
 * Copyright (c) Microsoft Corporation. All rights reserved.
 * Licensed under the MIT License.
 */ const SOURCES_THAT_SUPPORT_TOKEN_REVOCATION = [
 ...
 */ class ManagedIdentityApplication {
    constructor(configuration){
        ...
        this.fakeAuthority = new Authority(DEFAULT_AUTHORITY_FOR_MANAGED_IDENTITY, this.networkClient, ManagedIdentityApplication.nodeStorage, fakeAuthorityOptions, this.logger, this.cryptoProvider.createNewGuid(), undefined, true);
...
//# sourceMappingURL=00e17_%40azure_msal-node_lib_msal-node_cjs_4267e110._.js.map